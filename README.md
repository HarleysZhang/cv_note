...
作为一个计算机视觉算法工程师，需要掌握的不仅是计算机编程知识，还需要掌握机器学习、深度学习、图像识别、目标检测、语义分割等知识点，我整理了一个 [知识点思维导图](./data/images/CV算法工程师应掌握知识点.png)。

## 深度学习面试题

> 深度学习基础的一些面试题和 `Python` 编程相关的面试题，部分题目来源网上资料。

+ [深度学习面试题](5-deep_learning/4-深度学习面试题.md)
+ [Python 编程面试题](2-programming_language/python3/Python%20编程基础.md)
